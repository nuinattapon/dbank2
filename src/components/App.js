            ...
            <main role="main" className="col-lg-12 d-flex text-center">
              ...
              <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example">
                ...
                <Tab eventKey="withdraw" title="Withdraw">
                  ...
                  <div>
                    <button type='submit' className='btn btn-danger mt-3' onClick={(e) => this.withdraw(e)}>WITHDRAW</button>
                  </div>
                </Tab>
                <Tab eventKey="borrow" title="Borrow">
                  ...
                  <br></br>
                    ...
                    <form onSubmit={(e) => {
                      ...
                      <button type='submit' className='btn btn-success mt-3'>BORROW</button>
                    </form>
                  </div>
                </Tab>
                <Tab eventKey="payOff" title="Payoff">
                  ...
                  <br></br>
                    ...
                    <br></br>
                    <button type='submit' className='btn btn-warning mt-3' onClick={(e) => this.payOff(e)}>PAYOFF</button>
                  </div>
                </Tab>
              </Tabs>
              </div>
